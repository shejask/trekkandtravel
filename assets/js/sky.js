var can = Canvallax({
  ...
  (function(){
    ...
    var gradient = Canvallax.Rectangle({
      ...
      fill: (function(){
        ...
        gradient.addColorStop(0,'#054973');
        gradient.addColorStop(1,'#92dcf0');
        return gradient;
      })()
    });
  ...
  document.addEventListener("DOMContentLoaded", function() {
    // Simulate a delay (3 seconds) for demonstration purposes
    setTimeout(function() {
  ...
  window.addEventListener('load', function () {
    // After 3 seconds, hide the loading screen and redirect to another page
    setTimeout(function () {
